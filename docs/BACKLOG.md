...
- [x] **1.1 Drop two PDFs and see the highlighted diff overlay** _(the wow moment — build first)_
...
- [x] **1.2 Client-side PDF parsing and page rendering**
...
- [x] **1.3 Word-level diff mapped to on-page positions**
...
- [x] **1.4 Page navigation and change summary**
...
- [x] **1.5 Design polish — compare view**
...
- [x] **2.1 Handle mismatched page counts**
...
- [x] **2.2 Handle non-text / scanned PDFs**
...
- [x] **2.3 Handle large documents without freezing the UI**
...
- [x] **2.4 File validation and input error states**
...
- [x] **2.5 Design polish — empty, loading, and error states**
...
- [x] **3.1 Empty state explains the privacy model**
...
- [x] **3.3 Responsive layout across breakpoints**
...
- [x] **3.4 Static build deployable to a subpath**
...
- [x] **3.5 Design polish — whole-page cohesion**
